...
export const foods: Food[] = [
  { name: "Apple", key: 1, image: require("../assets/foods/apple.jpeg"), colour: '#AA150D', overallFodmapLevel: FodmapLevel.high, subtitle: 'All types, Raw', highFodmapServing: { servingSize: '200g', servingInfo: '1 medium apple' }, mediumFodmapServing: { servingSize: '31g', servingInfo: '1/8 medium apple' }, lowFodmapServing: { servingSize: '20g', servingInfo: '' }},
  { name: "Banana", key: 2, image: require("../assets/foods/banana.jpg"), colour: '#FED234', overallFodmapLevel: FodmapLevel.low },
  { name: "Orange", key: 3, image: require("../assets/foods/orange.png"), colour: '#FF9052', overallFodmapLevel: FodmapLevel.low, subtitle: 'Navel, Peeled, Raw' },
  { name: "Mango", key: 4, colour: "#FFA500", image: require("../assets/foods/mango.jpg") },
  { name: "Pineapple", key: 5, colour: "#FFD700", image: require("../assets/foods/pineapple.jpg") },
  { name: "Grape", key: 6, colour: "#800080", image: require("../assets/foods/grapes.jpg") },
  { name: "Watermelon", key: 7, colour: "#008000", image: require("../assets/foods/watermelon.jpg") },
  { name: "Strawberry", key: 8, colour: "#FF0000", image: require("../assets/foods/strawberry.jpg") },
